            ...
            children: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  if (succeed) {
                    showSimpleNotification(context, Text("已成功收藏${selectedList.length}首歌曲"));
                  } else {
                    showSimpleNotification(context, Text("加入歌单失败"), background: Theme.of(context).errorColor);
                  }
                },
              ),
              widget.onDelete == null
                  ...
                  : FlatButton(
                      ...
                      onPressed: () async {
                        ...
                        if (succeed) {
                          showSimpleNotification(context, Text("已删除${selectedList.length}首歌曲"),
